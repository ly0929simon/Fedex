...
public class SignatureProofOfDeliveryImageType implements java.io.Serializable {
    ...
    public static final SignatureProofOfDeliveryImageType PNG = new SignatureProofOfDeliveryImageType(_PNG);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v9", "SignatureProofOfDeliveryImageType"));
    }
    /**
